...
fun TipTimeLayout() {
    ...
    /** Se a gorjeta deve ser arredondada. */
    ...
    Column(
        ...
        EditNumberField( // Valor da conta
            ...
            keyboardOptions = KeyboardOptions.Default.copy(
                ...
                imeAction = ImeAction.Next // botão de próximo no teclado
            ),
            modifier = Modifier
        ...
        EditNumberField( // Porcentagem da gorjeta
            ...
            keyboardOptions = KeyboardOptions.Default.copy(
                keyboardType = KeyboardType.Number,
                imeAction = ImeAction.Done // botão de concluído no teclado
            ),
            modifier = Modifier
                .padding(bottom = 32.dp)
                .fillMaxWidth()
...
/** Botão Switch de arredondar gorjeta.*/
@Composable
fun RoundTheTipRow(
    roundUp: Boolean,
